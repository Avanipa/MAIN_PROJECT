...
$result=mysqli_query($conn,"SELECT  leave_type, applied_date, from_date, to_date, leave_reason FROM tbl_applied_leaves WHERE applied_leaves_reg_id='$id' order by applied_leaves_id desc limit 1") or die(mysqli_error($conn));
