...
$sql = "SELECT  leave_type, applied_date, from_date, to_date, leave_reason, leave_status FROM tbl_applied_leaves WHERE leave_status=2";
...
<div class="row cardBox">
   ...
   <a href="./pending_leave_status.php"><input type="submit" name="pending_leave" value="Pending Leave" class="btn btn-outline-warning"></a> &numsp;&numsp;&numsp;
   
    <a href="./leave_history.php"><input type="submit" name="back" value="Back" class="btn btn-outline-primary">
   	<br><br>
</div>
    <center><h4>Rejected Leave History</center>
    <center>
